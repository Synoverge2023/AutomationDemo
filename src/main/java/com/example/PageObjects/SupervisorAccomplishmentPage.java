...
public class SupervisorAccomplishmentPage extends GenericUtils {

	public SupervisorAccomplishmentPage() {
	...
	static Logger log = LogManager.getLogger(SupervisorAccomplishmentPage.class);
...
// 	    enterText(locators.getKey("Title"), Title);
	...
	public void clickOnExistingAccomplishmentSection() {
		clickOnElement(locators.getKey("ClickOnExistingAccomplishmentDashboard"));
		EscKey();
		log.info("STEP:Click on Pending module Successfully" + "ClickOnExistingAccomplishmentDashboard");
	...
	public void SelectExistingThirdEmployee() {
		scrollDown();
		clickOnElement(locators.getKey("SelectThirdEmployee"));
		log.info("STEP:Click on Third employee Successfully" + "SelectThirdEmployee");
...
//   	    enterText(locators.getKey("Title"), Title);
	...
	public void clickOnETSignoutButton() {
		clickOnElement(locators.getKey("ClickOnETProfile"));
		clickOnElement(locators.getKey("ClickOnSignout"));
